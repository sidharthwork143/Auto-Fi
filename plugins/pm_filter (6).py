...
from utils import imdb, get_size, is_subscribed, get_poster, search_gagala, temp, get_settings, save_group_settings, get_shortlink, check_verification, get_token, stream_site, get_tutorial, get_text
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('⛩️ Bot Update Channel', url=CHNL_LNK)
        ],[
            InlineKeyboardButton('🪐 Request Group', url=GRP_LNK)
        ],[
            InlineKeyboardButton('🔙', callback_data='start'),
            InlineKeyboardButton('Support 👮', url=f'https://t.me/GojoXSandman_Bot')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('🚩Bot Command', callback_data='admic')
        ], [
        ...
        buttons = [[
            InlineKeyboardButton('🎯 Support', url=f"https://t.me/{OWNER_USER_NAME}"),
...
async def auto_filter(client, msg, spoll=False):
    ...
    #     ])
    #     btn.insert(0, [
    #         InlineKeyboardButton("Paid Promotion Available", url=f"https://t.me/GojoXSandman_Bot"),
    #     ])
    # else:
        # btn.insert(0, [
        #     InlineKeyboardButton("Lᴀɴɢᴜᴀɢᴇs", callback_data=f"select_lang#{message.from_user.id}"),
